...
# 定义一周的课表
weekly_schedule = [
    "周一：化学、数学、数学、语文、生物、体育、体育、英语、英语、物理",
    "周二：语文、语文、化学、英语、英语、数学、数学、周测、周测、周测",
    "周三：数学、数学、生物、化学、物理、音/美、英语、英语、语文、语文",
    "周四：物理、化学、体育、语文、生物、英语、英语、数学、周测、周测",
    "周五：数学、数学、语文、生物、物理、班会、英语、选修、选修、补弱",
    "周六：无",
    "周日：无"
]
...
def create_gui():
    ...
    def update():
        ...
        canvas.create_text(w_main/2, 20, text=f"本周值日生：{duty} 值日生们幸苦了~", font=("宋体", 10, "bold"), fill="black", anchor="n")
        #canvas.create_text(w_main/2, 40, text=f"当前时间：{now}", font=("宋体", 20, "bold"), fill="black", anchor="n")
        canvas.create_text(w_main/2, 40, text=f"{rem} {extra}", font=("宋体", 20, "bold"), fill="red", anchor="n")
        time_now = get_time().split()[-1]
        now_now = datetime.strptime(time_now, "%H:%M:%S")
        t = datetime.strptime("12:38:00", "%H:%M:%S")
